...
for (let i = 0; i < projectDetail.length; i += 1) {
  ...
  for (let k = 0; k < projectDetail[i].exprience.length; k += 1) {
    experienceList +=
      k === 0
        ? `<li><a href="#" class="canopy">${projectDetail[i].exprience[k]}</a></li>`
        : `<li><a href="#">${projectDetail[i].exprience[k]}</a></li>`;
    if (k !== projectDetail[i].exprience.length - 1)
      experienceList +=
        '<li><a href="#"><img src="images/dot.svg" alt="dot"></a></li>';
  }
  ...
  <div class="card">
    ...
    <div class="card-text" >
      ...
      <p>${projectDetail[i].description}</p>
